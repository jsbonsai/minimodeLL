...
- Hosted CI (`macos-15`) passed on `0294d89`: push [run 35943293637](https://github.com/jsbonsai/minimodeLL/actions/runs/35943293637) and PR #20 [run 35943323556](https://github.com/jsbonsai/minimodeLL/actions/runs/35943323556). The workflow's `paths-ignore` skips Markdown-only commits after that.
