...
| [0010](0010-static-site-generation.md) | Static website rendered from repository Markdown; Actions-based Pages deployment | Accepted; deployed to https://jsbonsai.github.io/minimodeLL/ |
...
| [0012](0012-mcp-server-management-and-headers.md) | MCP server management in Settings: `enabled`, custom headers with Keychain secrets and a reserved list, derived auth modes, validated atomic editor locked under managed policy, owned-only Keychain cleanup, Test connection | Accepted; live MCP interoperability pending |
